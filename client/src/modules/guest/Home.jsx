...
function JobCard({ job }) {
  return (
    <div className="group border border-slate-200 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-200 bg-white overflow-hidden">
      <div className="p-5 space-y-4">
        ...
        <div className="flex gap-2 pt-2">
          <button
            className="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold shadow-sm hover:shadow-md px-3 py-2 rounded-lg transition-colors"
            style={{ backgroundColor: CTA_GREEN }}
          >
            Quick Apply
            </button>
